...
feedback: 
3) it should move with the mouse , the cube when use gizmo    DONE
4) hightlight the axe that you re moving   DONE
5) dont use the sliders, for movement and rotaion , keep numbers DONE
6) move elements blocking one thing 
